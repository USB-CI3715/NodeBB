...
/* These comments are because this file imported some modules form .js files, so the linter isn't working */
...
import { IPost, ITag, ITopic } from './interfaces/post.ts';
import { ISearchData } from './interfaces/search.ts';
